...
graph_builder.add_conditional_edges("email_reply", email_reply_conditional, ["review_email_reply", END])
...
# wb表示二进制写入模式
with open("02_email_triage_conditional_edges_list.png", "wb") as f:
    f.write(png_data)
print("图片已保存到 02_email_triage_conditional_edges_list.png")
